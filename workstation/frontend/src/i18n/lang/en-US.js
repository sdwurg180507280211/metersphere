...
const message = {
  sql_query: {
    ...
    pool_edit: 'Edit',
    pool_offline: 'Take Offline',
    pool_upload_title: 'Upload to Public Pool',
    pool_edit_title: 'Edit Public SQL',
    pool_summary: 'Summary',
    pool_summary_placeholder: 'Enter the summary shown on the public pool card',
    ...
    pool_offline_confirm: 'After taking it offline, others will no longer see this SQL in the public pool. Continue?',
    pool_offline_success: 'Taken offline',
    pool_offline_failed: 'Failed to take offline',
    pool_overwrite_confirm: 'The console already has SQL. Inserting will create and switch to a new local draft. Continue?',
    history: 'Query History',
    new_history_title: 'New Title',
    clear_history: 'Clear',
