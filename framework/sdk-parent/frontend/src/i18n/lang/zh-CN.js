...
const message = {
  ...
  custom_field: {
    ...
    case_priority: '用例等级',
    case_remark: '备注',
    case_retest_data: '复测数据',
    case_retest_pass: '复测是否通过',
    case_execution_method: '执行方式',
    case_execution_time: '执行时间',
    case_execution_result: '执行结果',
    case_pass: '是否通过',
    case_test_data: '测试数据',
    case_creator: '用例编写人',
    case_executor: '用例执行人',
    case_designer: '设计人',
    case_input_data: '输入数据',
    case_associated_system: '所属系统',
    issue_creator: '创建人',
    issue_processor: '处理人',
    issue_status: '状态',
    issue_severity: '严重程度',
    issue_associated_system: '缺陷所属系统',
    create: '创建字段',
    update: '更新字段',
    name: '模版字段',
    system_field: '系统字段',
  ...
  workspace: {
    ...
    custom_filed: {
      ...
      radio: '单选框',
      checkbox: '多选框',
      associatedSystem: '单选所属系统',
      multipleAssociatedSystem: '多选所属系统',
      member: '单选成员',
      multipleMember: '多选成员',
      date: '日期选择器',
      datetime: '日期时间选择器',
  ...
  organization: {
    ...
    associated_system: '所属系统',
    add_associated_system: '添加所属系统',
    associated_system_code: '系统简称',
    associated_system_input_name: '请输入所属系统名称',
    associated_system_delete_tip: '确认删除所属系统',
  ...
  member: {
    ...
    password_format_is_incorrect: '密码至少8位，必须同时包含字母、数字和特殊字符',
    old_password: '旧密码',
    new_password: '新密码',
  ...
  announcement: {
    ...
    content: '公告内容',
    preview: '预览',
    content_placeholder: '请输入公告内容，最多500字符',
    no_content: '无公告',
    enabled: '启用公告',
    disabled_hint: '公告已禁用',
    style: '公告样式',
    ...
    speed_unit: '秒',
    release_note: '需求上线',
    release_note_add: '新增上线记录',
    release_note_edit: '编辑上线记录',
    release_note_delete_confirm: '确认删除该上线记录？',
    release_note_title: '标题',
    release_note_content: '内容',
    release_note_creator: '创建人',
    release_note_create_time: '创建时间',
    banner_setting: '横幅公告设置',
    font_size: '字体大小',
    font_size_small: '小',
    font_size_medium: '中',
    font_size_large: '大',
    font_size_xlarge: '特大',
    no_setting_permission: '暂无系统设置权限，请联系管理员',
  },
};
