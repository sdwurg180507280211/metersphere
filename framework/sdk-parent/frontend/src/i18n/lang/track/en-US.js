export default {
  ...
  case: {
    ...
    excel: "Excel",
    minder: "Minder",
    onlyoffice_loading: "Loading Excel editor",
    onlyoffice_not_configured: "ONLYOFFICE editor URL is not configured",
    onlyoffice_config_hint: "Set onlyoffice.document-server-url and onlyoffice.storage-url in metersphere.properties, then restart test-track.",
    onlyoffice_load_timeout: "The Excel editor is taking longer than expected to load",
    onlyoffice_load_timeout_hint: "Check that ONLYOFFICE and the document host are reachable.",
    onlyoffice_open_new_window: "Open in new window",
    onlyoffice_reload: "Regenerate",
    onlyoffice_sync_state: "Sync state",
    onlyoffice_waiting: "Preparing functional cases Excel",
    onlyoffice_plan_required: "Test plan ID is missing",
    onlyoffice_script_load_failed: "ONLYOFFICE script failed to load",
    onlyoffice_save: "Save to case library",
    onlyoffice_saving: "Saving to case library",
    onlyoffice_save_triggered: "Save request submitted, waiting for ONLYOFFICE callback",
    onlyoffice_save_timeout: "No ONLYOFFICE save callback was received. Check the editor connection.",
    onlyoffice_save_failed: "Failed to save to case library",
    onlyoffice_dirty: "Excel has unsaved changes",
    onlyoffice_error_detail: "Error details",
    step_info: "Step Info",
    ...
    minder_create_tip: "failed, unable to create its parent system in minder",
    ...
    minder_is_module_tip: "{0} is a system and cannot be modified as a use ca",
    minder_not_module_tip:
      "System {0}, cannot be created under a non-system node",
    minder_all_module_tip:
      "All case are virtual systems. Please create use cases in other systems",
    ...
    input_module: "Please select system",
  ...
  module: {
    ...
    rename: "Rename",
    add_submodule: "Add subsystem",
    add_module: "Add system",
    name: "Name",
    delete_confirm: "Confirm delete system:",
    delete_all_resource: "and all subsystems and test cases under the system",
    ...
    success_create: "System create successfully",
    case_module_already_exists:
      "The system name already exists at the same level",
  },
  home: {
  ...
  issue: {
    ...
    transition_history_empty: "No transition history",
    no_available_transitions: "No available transitions",
