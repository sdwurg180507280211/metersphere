export default {
  ...
  case: {
    ...
    excel: "Excel",
    minder: "脑图",
    onlyoffice_loading: "正在加载 Excel 编辑器",
    onlyoffice_not_configured: "未配置 ONLYOFFICE 编辑器地址",
    onlyoffice_config_hint: "请在 metersphere.properties 中配置 onlyoffice.document-server-url、onlyoffice.storage-url 后重启测试跟踪服务。",
    onlyoffice_load_timeout: "Excel 编辑器加载时间较长",
    onlyoffice_load_timeout_hint: "请检查 ONLYOFFICE 服务及测试宿主页是否可以访问。",
    onlyoffice_open_new_window: "新窗口打开",
    onlyoffice_reload: "重新生成",
    onlyoffice_sync_state: "同步状态",
    onlyoffice_waiting: "正在准备功能用例 Excel",
    onlyoffice_plan_required: "缺少测试计划 ID",
    onlyoffice_script_load_failed: "ONLYOFFICE 脚本加载失败",
    onlyoffice_save: "保存到用例库",
    onlyoffice_saving: "正在保存到用例库",
    onlyoffice_save_triggered: "已提交保存请求，等待 ONLYOFFICE 回调",
    onlyoffice_save_timeout: "未收到 ONLYOFFICE 保存回调，请检查编辑器连接状态",
    onlyoffice_save_failed: "保存到用例库失败",
    onlyoffice_dirty: "Excel 有未保存修改",
    onlyoffice_error_detail: "错误详情",
    step_info: "步骤信息",
    other_info: "其他信息",
    step_describe: "步骤描述",
    step_describe_tip:
    ...
    change_type: "更改类型",
    minder_create_tip: "失败, 无法在脑图创建其父系统",
    minder_tem_node_tip: "无法在临时节点{0}下创建用例",
    minder_is_module_tip: "{0}是系统，不能修改为用例",
    minder_not_module_tip: "系统{0}，不能创建在非系统节点下",
    minder_all_module_tip: "全部用例为虚拟系统，请在其他系统创建用例",
  ...
  module: {
    id: "系统ID",
    search: "搜索系统",
    search_by_name: "通过系统名称搜索",
    rename: "重命名",
    add_submodule: "添加子系统",
    add_module: "添加系统",
    name: "系统名称",
    delete_confirm: "确认删除系统: ",
    delete_batch_confirm: "确认批量删除勾选的场景步骤？",
    delete_all_resource: "以及系统下所有子系统和测试用例",
    ...
    project_name: "所属项目",
    input_name: "请输入系统名称",
    success_create: "系统创建成功",
    case_module_already_exists: "同层级下已经存在该系统名称",
  },
  home: {
    recent_test: "最近测试",
    my_plan: "我的计划",
  ...
  issue: {
    ...
    status_on_hold: "挂起",
    transition_history: "流转记录",
    transition_comment: "流转备注",
    from_status: "流转前状态",
    to_status: "流转后状态",
    operator: "操作人",
    transition_time: "流转时间",
    transition_history_empty: "暂无流转记录",
    no_available_transitions: "无可用状态流转",
