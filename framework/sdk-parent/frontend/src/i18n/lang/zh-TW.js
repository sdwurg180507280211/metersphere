...
const message = {
  ...
  custom_field: {
    ...
    case_priority: '用例等級',
    case_remark: '備註',
    case_retest_data: '復測數據',
    case_retest_pass: '復測是否通過',
    case_execution_method: '執行方式',
    case_execution_time: '執行時間',
    case_execution_result: '執行結果',
    case_pass: '是否通過',
    case_test_data: '測試數據',
    case_creator: '用例編寫人',
    case_designer: '設計人',
    case_executor: '用例執行人',
    case_input_data: '輸入數據',
    case_associated_system: '所屬系統',
    issue_creator: '創建人',
    issue_processor: '處理人',
    issue_status: '狀態',
    issue_severity: '嚴重程度',
  ...
  workspace: {
    ...
    custom_filed: {
      ...
      radio: '單選框',
      checkbox: '多選框',
      associatedSystem: '單選所屬系統',
      multipleAssociatedSystem: '多選所屬系統',
      member: '單選成員',
      multipleMember: '多選成員',
      date: '日期選擇器',
      datetime: '日期時間選擇器',
  ...
  organization: {
    ...
    associated_system: '所屬系統',
    add_associated_system: '添加所屬系統',
    associated_system_code: '系統簡稱',
    associated_system_input_name: '請輸入所屬系統名稱',
    associated_system_delete_tip: '確認刪除所屬系統',
  ...
  member: {
    ...
    password_format_is_incorrect: '密碼至少8位，必須同時包含字母、數字和特殊字符',
    old_password: '舊密碼',
    new_password: '新密碼',
  ...
  announcement: {
    ...
    content: '公告內容',
    preview: '預覽',
    content_placeholder: '請輸入公告內容，最多500字符',
    no_content: '無公告',
    enabled: '啟用公告',
    disabled_hint: '公告已禁用',
    style: '公告樣式',
    ...
    text_color: '文字顏色',
    scroll: '滾動效果',
    scroll_hint: '開啟後公告內容將從右向左滾動顯示',
    release_note: '需求上線',
    release_note_add: '新增上線記錄',
    release_note_edit: '編輯上線記錄',
    release_note_delete_confirm: '確認刪除該上線記錄？',
    release_note_title: '標題',
    release_note_content: '內容',
    release_note_creator: '創建人',
    release_note_create_time: '創建時間',
    banner_setting: '橫幅公告設置',
    font_size: '字體大小',
    font_size_small: '小',
    font_size_medium: '中',
    font_size_large: '大',
    font_size_xlarge: '特大',
    no_setting_permission: '暫無系統設置權限，請聯繫管理員',
  },
};
