...
export const REPORT_SCENARIO_CONFIGS = [ID, NAME, TEST_NAME, CREATE_TIME, STATUS, CREATOR, TRIGGER_MODE];

export const REPORT_CONFIGS = [NAME, TEST_NAME, CREATE_TIME, PERFORMANCE_REPORT_STATUS, CREATOR, TRIGGER_MODE];

export const REPORT_CASE_CONFIGS = [ID, NAME, CREATE_TIME, STATUS, CREATOR, TRIGGER_MODE];
