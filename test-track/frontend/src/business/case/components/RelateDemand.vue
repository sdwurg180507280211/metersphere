...
<!--        <el-form-item :label="$t('test_track.case.demand_num')" prop="demandName" v-if="form.demandId === 'other'">-->
<!--          <el-input v-model="form.demandName"></el-input>-->
<!--        </el-form-item>-->

        <el-form-item :label="$t('test_track.case.demand_num')" prop="demandName">
          <el-input v-model="form.demandName"></el-input>
        </el-form-item>
      </el-form>
...
<!--                   @keydown.enter.native.prevent size="small" :disabled="!form.demandId" style="margin-left: 12px">{{ $t('commons.confirm') }}</el-button>-->
        <el-button v-prevent-re-click type="primary" @click="submit"
