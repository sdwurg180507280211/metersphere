...
const message = {
  ...
  plan: {
    ...
    export_test_plan: "導出測試計劃",
    export_test_plan_tip: "確認導出當前篩選條件下的測試計劃數據？",
    test_plan_export_excel: "測試計劃列表",
    test_plan_export_excel_sheet: "測試計劃",
    plan_name: "計劃名稱",
    plan_principal: "計劃負責人",
    plan_creator: "創建人",
    plan_stage: "計劃階段",
    plan_status: "狀態",
    test_case_count: "用例總數",
    api_case_count: "接口用例",
    api_scenario_count: "接口場景",
    ui_scenario_count: "UI場景",
    load_case_count: "性能用例",
    plan_project: "所屬項目",
    planned_start_time: "計劃開始時間",
    planned_end_time: "計劃結束時間",
    create_time: "創建時間",
    update_time: "更新時間",
  },
  review: {
