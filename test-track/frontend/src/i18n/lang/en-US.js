...
const message = {
  ...
  plan: {
    ...
    export_test_plan: "Export Test Plan",
    export_test_plan_tip: "Confirm to export test plan data under current filter conditions?",
    test_plan_export_excel: "Test Plan List",
    test_plan_export_excel_sheet: "Test Plan",
    plan_name: "Plan Name",
    plan_principal: "Principal",
    plan_creator: "Creator",
    plan_stage: "Stage",
    plan_status: "Status",
    test_case_count: "Total Case",
    api_case_count: "API Case",
    api_scenario_count: "API Scenario",
    ui_scenario_count: "UI Scenario",
    load_case_count: "Performance Case",
