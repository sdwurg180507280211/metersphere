...
const message = {
  ...
  plan: {
    ...
    export_test_plan: "导出测试计划",
    export_test_plan_tip: "确定导出当前筛选条件下的测试计划数据？",
    test_plan_export_excel: "测试计划列表",
    test_plan_export_excel_sheet: "测试计划",
    plan_name: "计划名称",
    plan_principal: "计划负责人",
    plan_creator: "创建人",
    plan_stage: "计划阶段",
    plan_status: "状态",
    test_case_count: "用例总数",
    api_case_count: "接口用例",
    api_scenario_count: "接口场景",
    ui_scenario_count: "UI场景",
